  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-xl font-bold">Analyseur Strava</CardTitle>
          <CardDescription>
            Analysez automatiquement vos séances de fractionné et enrichissez
            leur description.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground mb-6">
            Pour utiliser cette application, vous devez vous connecter avec
            votre compte Strava.
          </p>
        </CardContent>
        <CardFooter>
